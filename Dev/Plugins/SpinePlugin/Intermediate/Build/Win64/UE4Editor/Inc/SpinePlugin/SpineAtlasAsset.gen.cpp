...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_USpineAtlasAsset_Statics::NewProp_atlasFileName = { "atlasFileName", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USpineAtlasAsset, atlasFileName), METADATA_PARAMS(Z_Construct_UClass_USpineAtlasAsset_Statics::NewProp_atlasFileName_MetaData, ARRAY_COUNT(Z_Construct_UClass_USpineAtlasAsset_Statics::NewProp_atlasFileName_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USpineAtlasAsset_Statics::NewProp_rawData_MetaData[] = {
		{ "ModuleRelativePath", "Public/SpineAtlasAsset.h" },
	};
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_USpineAtlasAsset_Statics::NewProp_rawData = { "rawData", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USpineAtlasAsset, rawData), METADATA_PARAMS(Z_Construct_UClass_USpineAtlasAsset_Statics::NewProp_rawData_MetaData, ARRAY_COUNT(Z_Construct_UClass_USpineAtlasAsset_Statics::NewProp_rawData_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_USpineAtlasAsset_Statics::NewProp_atlasPages = { "atlasPages", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USpineAtlasAsset, atlasPages), METADATA_PARAMS(Z_Construct_UClass_USpineAtlasAsset_Statics::NewProp_atlasPages_MetaData, ARRAY_COUNT(Z_Construct_UClass_USpineAtlasAsset_Statics::NewProp_atlasPages_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USpineAtlasAsset_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_USpineAtlasAsset_Statics::PropPointers),
		0,
		0x009000A0u,
		METADATA_PARAMS(Z_Construct_UClass_USpineAtlasAsset_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_USpineAtlasAsset_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(USpineAtlasAsset, 1018114266);
