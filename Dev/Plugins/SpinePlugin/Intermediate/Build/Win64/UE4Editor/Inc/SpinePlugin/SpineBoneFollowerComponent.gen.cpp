...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USpineBoneFollowerComponent_Statics::NewProp_UseRotation = { "UseRotation", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(USpineBoneFollowerComponent), &Z_Construct_UClass_USpineBoneFollowerComponent_Statics::NewProp_UseRotation_SetBit, METADATA_PARAMS(Z_Construct_UClass_USpineBoneFollowerComponent_Statics::NewProp_UseRotation_MetaData, ARRAY_COUNT(Z_Construct_UClass_USpineBoneFollowerComponent_Statics::NewProp_UseRotation_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USpineBoneFollowerComponent_Statics::NewProp_UsePosition = { "UsePosition", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(USpineBoneFollowerComponent), &Z_Construct_UClass_USpineBoneFollowerComponent_Statics::NewProp_UsePosition_SetBit, METADATA_PARAMS(Z_Construct_UClass_USpineBoneFollowerComponent_Statics::NewProp_UsePosition_MetaData, ARRAY_COUNT(Z_Construct_UClass_USpineBoneFollowerComponent_Statics::NewProp_UsePosition_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USpineBoneFollowerComponent_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_USpineBoneFollowerComponent_Statics::PropPointers),
		0,
		0x00B000A4u,
		METADATA_PARAMS(Z_Construct_UClass_USpineBoneFollowerComponent_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_USpineBoneFollowerComponent_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(USpineBoneFollowerComponent, 1734107423);
